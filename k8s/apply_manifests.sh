...
if [ -z "$MCP_ACCESS_ROLE_NAME" ]; then
  echo "Warning: MCP_ACCESS_ROLE_NAME environment variable is not set. Using default value 'sre-agent-MCP-access-role'."
  export MCP_ACCESS_ROLE_NAME="sre-agent-MCP-access-role"
fi
